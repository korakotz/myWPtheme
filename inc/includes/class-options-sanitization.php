...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'WP-Trigger' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'WP-Trigger' ),
		'repeat-y'  => __( 'Repeat Vertically', 'WP-Trigger' ),
		'repeat'    => __( 'Repeat All', 'WP-Trigger' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'WP-Trigger' ),
		'top center'    => __( 'Top Center', 'WP-Trigger' ),
		'top right'     => __( 'Top Right', 'WP-Trigger' ),
		'center left'   => __( 'Middle Left', 'WP-Trigger' ),
		'center center' => __( 'Middle Center', 'WP-Trigger' ),
		'center right'  => __( 'Middle Right', 'WP-Trigger' ),
		'bottom left'   => __( 'Bottom Left', 'WP-Trigger' ),
		'bottom center' => __( 'Bottom Center', 'WP-Trigger' ),
		'bottom right'  => __( 'Bottom Right', 'WP-Trigger')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'WP-Trigger' ),
		'fixed'  => __( 'Fixed in Place', 'WP-Trigger')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'WP-Trigger' ),
		'italic'      => __( 'Italic', 'WP-Trigger' ),
		'bold'        => __( 'Bold', 'WP-Trigger' ),
		'bold italic' => __( 'Bold Italic', 'WP-Trigger' )
		);
